...
@section('title', 'JSON Minifier - ' . config('app.name'))
...
<div class="min-h-screen bg-gray-50 dark:bg-gray-900">
    <nav class="bg-white dark:bg-gray-800 border-b border-gray-200 dark:border-gray-700">
        <div class="max-w-7xl mx-auto px-4 py-3">
            ...
            <span class="text-gray-900 dark:text-white">JSON Minifier</span>
        </div>
    </nav>
    ...
    <div class="max-w-7xl mx-auto px-4 py-12">
        <div class="grid grid-cols-1 lg:grid-cols-2 gap-8">
            <div class="bg-white dark:bg-gray-800 rounded-lg shadow-lg p-8">
                <h2 class="text-2xl font-bold text-gray-900 dark:text-white mb-4">Original JSON</h2>
                <textarea
                    x-model="input"
                    @input="minify()"
            ...
            <div class="bg-white dark:bg-gray-800 rounded-lg shadow-lg p-8">
                ...
                <div class="bg-gray-50 dark:bg-gray-700 px-4 py-3 rounded-lg border border-gray-300 dark:border-gray-600 text-gray-900 dark:text-white font-mono text-sm max-h-96 overflow-auto break-all">
